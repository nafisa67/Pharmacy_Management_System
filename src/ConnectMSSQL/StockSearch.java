...
public class StockSearch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("SEARCH IN STOCK");
        ...
        Addnew.setBackground(new java.awt.Color(22, 161, 196));
        ...
        search.setBackground(new java.awt.Color(22, 161, 196));
        ...
        update.setBackground(new java.awt.Color(22, 161, 196));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Addnew, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try {
            ...
            String sql = "Select * from StockedMedicine where MedicineName='" + mname.getText() + "'";
            ResultSet rs = st.executeQuery(sql);

            if (rs.next()) {
                String pr = Float.toString(rs.getFloat("MedicinePrice"));
                price.setText(pr);
                category.setText(rs.getString("MedicineCategory"));
                String quan = Integer.toString(rs.getInt("MedicineQuantity"));
                quantity.setText(quan);
                String DOB = String.valueOf(rs.getDate("MedicineExpireDate"));
                edate.setText(DOB);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if (checkAllFieldsFilled(jPanel2)) {
            ...
            try {
                System.out.println("eghro");

                Connection con = ConnectMSSQL.connectDB();
                String sql = "UPDATE StockedMedicine set MedicineName=?,MedicineCategory=?,MedicinePrice=?,MedicineQuantity=?,MedicineExpireDate=? where MedicineName='" + mnme + "'";
    ...
    private void AddnewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddnewActionPerformed
        // TODO add your handling code here:
        dispose();
        MedicineStock loadpage = new MedicineStock();
        loadpage.show();
